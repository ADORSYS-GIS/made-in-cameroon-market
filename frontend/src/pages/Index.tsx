          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100 leading-relaxed">
                A platform just for locally made products, where artisans,
                farmers, and small businesses can sell their goods without
                competing with big foreign brands.
              </p>
            ...
            {[
              {
                ...
                description:
                  "Specializing in handwoven baskets and traditional decorative items crafted by local artisans using sustainable materials.",
              },
              {
                ...
                description:
                  "Premium supplier of organic fruits and vegetables sourced directly from local farmers in the Littoral region.",
              },
              {
                ...
                description:
                  "Fresh seafood and fish products from the coastal waters of Kribi, supporting local fishing communities.",
              },
            ].map((vendor, index) => (
              <motion.div
                key={index}
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative">
          ...
          <p className="text-blue-100 text-xl mb-12 leading-relaxed">
            Whether you're an artisan, farmer, or small business owner, our
            platform gives you the tools to reach customers across Cameroon.
          </p>
